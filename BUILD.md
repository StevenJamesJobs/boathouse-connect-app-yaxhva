...
|---|---|---|---|---|---|---|
| 2026-09-08 | MyResto (public) | 1.0.0 (16) | `08e5112` | Claude (MacBook) — EAS `production-public`, non-interactive via `npx eas-cli@latest` (23.2) | Transporter (Steve) — **pending** | **The first SDK 57 build** (s82: Expo 54 → 57, RN 0.86.3, React 19.2.3, Hermes V1, expo-router 57, Reanimated 4.5; errorLogger login-mount fix = Sentry REACT-NATIVE-5; ten dead deps dropped incl. react-native-maps). EAS id `a35cad02-3b30-4157-80ab-3d82a72e87e3`; started 2026-09-08 17:19 UTC, IN_PROGRESS with no queue wait. Update this row when delivered. |
