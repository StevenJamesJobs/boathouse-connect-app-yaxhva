...
export default function BartenderClosingChecklistScreen() {
  ...
  const loadChecklist = async () => {
    console.log('Loading Bartender Closing Checklist for user:', user?.id);
    try {
      setLoading(true);
      ...
      console.log('Loaded bartender closing checklist with', categoriesWithItems.length, 'categories');
    } catch (error) {
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={[styles.header, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text }]}>{t('checklist.title_bartender_closing')}</Text>
