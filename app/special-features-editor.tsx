...
export default function SpecialFeaturesEditorScreen() {
  ...
  const translation = useTranslationSection({
    ...
    sessionKey: editingFeature ? `edit:${editingFeature.id}` : `new:${addSessionRef.current}`,
    active: showAddModal,
  });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingFeature) {
        ...
        // The new special feature shows in the notification shade live (via the
        // special_features table). No separate custom_notifications "log" row — that
                ...
                <View style={styles.notificationToggleContainer}>
                  <View style={styles.notificationToggleTextContainer}>
                    ...
                    <Text style={styles.notificationToggleHint}>
                      Select whether to send a push notification when this special feature is published.
                    </Text>
                  </View>
                  <Switch
