...
export default function SummerLibationRecipesScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <AmbientGlow />
      <ScreenHeader
        title={t('summer_libation_recipes.title')}
        rightWide={isManager}
        right={isManager ? (
          <HeaderNavMenu
            ...
            iconIos="pencil"
            iconAndroid="edit"
            sheetTitle={t('summer_libation_recipes.title')}
            actions={[
              {
                key: 'switch',
                label: t('common:to_editor'),
                iosIcon: 'pencil',
                androidIcon: 'edit',
                onPress: () => router.replace('/summer-libation-recipes-editor'),
              },
              {
                key: 'cats',
      ...
      <View style={styles.searchRow}>
        <View style={[styles.searchField, { backgroundColor: colors.glass, borderColor: colors.glassBorder }]}>
          ...
          <TextInput
            ...
            placeholder={t('summer_libation_recipes.search_placeholder')}
          ...
          {Object.keys(recipesByCategory).length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              <Text style={[styles.emptyText, { color: colors.text }]}>
                {query ? t('cocktails.no_results') : t('summer_libation_recipes.no_recipes')}
              </Text>
              <Text style={[styles.emptySubtext, { color: colors.textSecondary }]}>
                {query ? t('cocktails.no_results_hint') : t('summer_libation_recipes.check_back')}
              </Text>
            </View>
          ) : (
            <>
