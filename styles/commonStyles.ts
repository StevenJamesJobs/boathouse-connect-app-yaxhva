...
export const themePalettes: Record<PresetPaletteId, ThemePalette> = {
  // ── Moonstone — MyResto Connect default (dark). s86: RE-TUNED to the MyResto
  //    logo — ring navy #1F2334 as the ground/glow, bolt orange #F99861 as the
  //    tint, notch grey #ACAFB3 as the quiet accent (`ember`), plate white
  //    #FCFCFC as the text. Same id, same slot: no seventh theme. ───────────
  moonstone: {
    label: 'Moonstone',
    hue: 22,
    previewColors: ['#E8EAF0', '#ACAFB3', '#F99861', '#141724'],
    light: {
      background: '#F2F3F6',
      text: '#1F2334',
      ...
      highlight: '#E6E8EE',
      border: '#D5D8E0',
      tabBarBackground: '#E9EBF0',
      tabBarActive: '#1F2334',
      tabBarInactive: '#8A90A2',
      accent: '#DC6A2E',
      darkText: '#1F2334',
      darkSecondaryText: '#6B7084',
      tint: '#DC6A2E',
      ember: '#3A4158',
      fireText: '#FFFFFF',
      blue: '#7E879C',
      ...
      surfaceBorder: 'rgba(31,35,52,0.08)',
      hairline: 'rgba(31,35,52,0.08)',
      navTint: 'rgba(255,255,255,0.50)',
      sheen: 'rgba(255,255,255,0.92)',
      thumbPlaceholder: '#DDDFE6',
      glowA: 'rgba(31,35,52,0.14)',
      glowB: 'rgba(249,152,97,0.20)',
    },
    dark: {
      background: '#141724',
      text: '#FCFCFC',
      ...
      highlight: '#262B40',
      border: '#2C3148',
      tabBarBackground: '#141724',
      tabBarActive: '#E8EAF0',
      tabBarInactive: '#A3A8B8',
      accent: '#F99861',
      darkText: '#FCFCFC',
      darkSecondaryText: '#A3A8B8',
      tint: '#F99861',
      ember: '#B9BDC6',
      fireText: '#1F2334',
      blue: '#8F98B0',
      ...
      navTint: 'rgba(20,23,36,0.42)',
      sheen: 'rgba(255,255,255,0.13)',
      thumbPlaceholder: '#232840',
      glowA: 'rgba(92,106,178,0.36)',
      glowB: 'rgba(249,152,97,0.11)',
    },
  },
